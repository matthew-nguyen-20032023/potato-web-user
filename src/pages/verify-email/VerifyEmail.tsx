...
import { checkVerifyEmailAPI, verifyEmailAPI } from "@/api/auth.ts";
        ...
        <div className="max-w-md mx-auto border border-black rounded-xl p-6 mb-4">
          <h3 className="mb-2">
            <span className="text-blue-500">
              (╥﹏╥) This link is invalid or has expired
            </span>
            . Please check your email for a new one, or contact us for support.
          </h3>
        </div>
      )}
    </div>
